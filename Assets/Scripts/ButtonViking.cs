...
public class ButtonViking : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    ...
    void Start()
    {
        // Encontra o GameObject com o nome "VikingBotao" e pega o componente Image
        GameObject vikingBotao = GameObject.Find("VikingBotao");

        if (vikingBotao == null)
        {
            Debug.LogError("Botão com o nome 'VikingBotao' não foi encontrado!");
            return;
        }

        buttonImage = vikingBotao.GetComponent<Image>();

        if (buttonImage == null)
        {
            Debug.LogError("O botão 'VikingBotao' não possui o componente Image!");
            return;
        }
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        ToggleOtherButtonsVisibility();
            ...
            PlayerPrefs.SetInt("IndexPersonagem", 4);
